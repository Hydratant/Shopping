package com.tami.shopping.view
...
import com.tami.shopping.ui.main.MainTab
import java.util.*
...
class BottomNavigator(
    ...
    override fun popBackStack(): Boolean {
        backStack.pollLast() ?: return true
    ...
    class Destination(navigator: BottomNavigator) : NavDestination(navigator) {
        ...
        override fun onInflate(context: Context, attrs: AttributeSet) {
            ...
            className = context.resources.obtainAttributes(attrs, R.styleable.FragmentNavigator)
                .use { it.getString(R.styleable.FragmentNavigator_android_name) }
        }
    }
